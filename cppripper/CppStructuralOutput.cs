...
namespace CppRipper
{
    ...
    public interface IAstPrinter
    {
        ...
        void PrintFunction(ParseNode node,int depth);
    }
        ...
        : IAstPrinter
    {
        ...
        public virtual void PrintFunction(ParseNode node,int depth)
        {
            throw new NotImplementedException();
        }
        #endregion
    ...
    public class CppStructuralOutput
        : AstTextPrinter
    {
        private List<FunctionDefine> funList = new List<FunctionDefine>();
        ...
        public List<FunctionDefine> getFunctionList()
        {
            return funList;
        }
    }
